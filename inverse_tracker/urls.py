...
urlpatterns = [
    ...
    path('api/courses/', CourseAPIListView.as_view()),
    path('api/courses/category/<int:pk>/', CourseAPICategoryListView.as_view()),
    path('api/courses/<int:pk>/', CourseAPIRetrieveView.as_view()),
    path('api/courses/<int:pk>/document/', CourseAPIRetrieveDocumentView.as_view()),
    path('api/courses/<int:pk>/edit/', CourseAPIUpdateDestroyView.as_view()),
    path('api/courses/create/', CourseAPICreateView.as_view()),
    ...
    path('api/courses/groups/applications/<int:pk>/document/', ApplicationAPIRetrieveDocumentView.as_view()),
